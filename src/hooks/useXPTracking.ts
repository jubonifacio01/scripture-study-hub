...
export interface SessionRecord {
  ...
  objectiveId?: string;
  journeyId?: string;
  /** Highest answer streak reached during this session (for combo-based achievements) */
  comboMax?: number;
  /** Full ISO timestamp of completion (for time-of-day achievements). `date` above is kept for back-compat. */
  completedAt?: string;
}
