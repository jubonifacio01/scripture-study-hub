...
export function ScoreCard({ result, onPlayAgain, onExit }: ScoreCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 grid grid-cols-3 divide-x divide-border rounded-[16px] border border-border">
      ...
      <div className="mt-8 flex flex-col gap-2">
        <Button
          size="lg"
          onClick={onPlayAgain}
          className="press h-12 rounded-[16px] bg-primary text-primary-foreground hover:bg-primary/90"
        >
          Praticar novamente
        </Button>
        <Button
          ...
          variant="ghost"
          onClick={onExit}
          className="h-12 rounded-[16px] text-muted-foreground hover:text-foreground"
        >
          Voltar ao início
        </Button>
      </div>
