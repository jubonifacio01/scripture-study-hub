    ...
    >
      ...
      {journey.id === "jesus" && (
        <>
          ...
          {/* Rays */}
          <path d="M160 30 L 160 45" stroke={color} strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M160 95 L 160 110" stroke={color} strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M120 70 L 135 70" stroke={color} strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M185 70 L 200 70" stroke={color} strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M130 40 L 140 50" stroke={color} strokeWidth="1.5" strokeOpacity="0.15" strokeLinecap="round" />
          <path d="M180 50 L 190 40" stroke={color} strokeWidth="1.5" strokeOpacity="0.15" strokeLinecap="round" />
          <path d="M130 100 L 140 90" stroke={color} strokeWidth="1.5" strokeOpacity="0.15" strokeLinecap="round" />
          <path d="M180 90 L 190 100" stroke={color} strokeWidth="1.5" strokeOpacity="0.15" strokeLinecap="round" />
        </>
      )}
